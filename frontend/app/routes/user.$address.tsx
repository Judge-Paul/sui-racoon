  ...
  return (
    <main className="mx-auto flex w-full max-w-6xl grow flex-col items-center px-4 py-8 pt-32 md:px-0">
      <section className="glass-panel animate-fade-in-up group relative mb-10 w-full overflow-hidden rounded-3xl p-6 md:p-10">
        <div className="pointer-events-none absolute -top-24 -right-24 h-64 w-64 rounded-full bg-slate-900/10 blur-3xl"></div>

        <div className="relative z-10 flex flex-col items-start justify-between gap-6 md:flex-row md:items-center">
          <div className="flex w-full flex-col items-center gap-6 sm:flex-row sm:items-start">
            <div className="relative">
              <div className="h-24 w-24 rounded-full bg-linear-to-tr from-slate-900 to-transparent p-1 md:h-32 md:w-32">
                <img
            ...
            <div className="flex flex-col items-center pt-2 sm:items-start">
              <h1 className="font-display mb-1 text-3xl font-bold tracking-tight text-slate-900 md:text-4xl">
                Alex Student
              </h1>
              ...
              <div className="flex flex-wrap justify-center gap-2 sm:justify-start">
                ...
                <span className="flex items-center gap-1.5 rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-xs font-semibold text-blue-700">
          ...
          <div className="mt-4 flex w-full justify-center gap-3 md:mt-0 md:w-auto md:justify-end">
            <button
              className="flex h-11 w-11 cursor-pointer items-center justify-center rounded-full border border-slate-200 bg-white text-slate-600 shadow-sm ease-in-out hover:scale-110 hover:bg-white/50 active:scale-90"
              title="Show QR Code"
            >
            ...
            <button className="flex h-11 cursor-pointer items-center gap-2 rounded-full bg-slate-900 px-5 text-sm font-semibold text-white shadow-sm ease-in-out hover:scale-105 hover:bg-slate-900/95 active:scale-90">
              <span className="material-symbols-outlined text-[18px]">
                share
              </span>
              Share
      ...
      <section className="mb-12 grid w-full grid-cols-1 gap-4 sm:grid-cols-3">
        <div className="shadow-card hover:shadow-card-hover group flex cursor-pointer flex-col gap-1 rounded-2xl border border-slate-100 bg-white/60 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[103%]">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-slate-500">Badges Earned</p>
            <div className="rounded-lg bg-slate-900/10 p-2 text-slate-900 transition-colors">
              <span className="material-symbols-outlined text-[20px]">
                military_tech
              </span>
            </div>
          </div>
          <p className="font-display text-4xl font-bold text-slate-900">12</p>
        </div>
        <div className="shadow-card hover:shadow-card-hover group flex cursor-pointer flex-col gap-1 rounded-2xl border border-slate-100 bg-white/60 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[103%]">
          <div className="flex items-center justify-between">
          ...
          <p className="font-display text-4xl font-bold text-slate-900">5</p>
        </div>
        <div className="shadow-card hover:shadow-card-hover group flex cursor-pointer flex-col gap-1 rounded-2xl border border-slate-100 bg-white/60 p-6 backdrop-blur-sm transition-all duration-300 hover:scale-[103%]">
          <div className="flex items-center justify-between">
            <p className="text-sm font-medium text-slate-500">Years Active</p>
            <div className="rounded-lg bg-slate-900/10 p-2 text-slate-900 transition-colors">
              <span className="material-symbols-outlined text-[20px]">
                history
              </span>
          ...
          <p className="font-display text-4xl font-bold text-slate-900">2</p>
        </div>
      </section>
