...
const badgeSchema = z.object({
  ...
  title: z.string().min(2, "Title is too short").max(100, "Max 100 characters"),
  description: z
    .string()
...
export function meta({}: Route.MetaArgs) {
  return [
    ...
    {
      name: "description",
      content: "Issue badges to students as an organizer.",
    },
  ];
}
  ...
  const onSubmit = async (data: BadgeFormValues) => {
    ...
    txb.moveCall({
      ...
      arguments: [
        ...
        txb.pure(
          bcs.vector(bcs.u8()).serialize(new TextEncoder().encode(data.title)),
        ),
        txb.pure(
          bcs
            .vector(bcs.u8())
  ...
  if (connectionStatus !== "connected") {
    return (
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="glass-panel animate-fade-in-up max-w-md rounded-xl p-8 text-center">
      ...
      <div className="flex min-h-screen items-center justify-center px-4">
        <div className="glass-panel animate-fade-in-up max-w-md rounded-xl p-8 text-center">
          ...
          <p className="mb-4 text-slate-400">
            You don't have an Organizer Pass. Only authorized organizers can
            issue badges.
          </p>
          <p className="text-xs text-slate-500">
            Contact an admin to get an Organizer Pass for your address:
          </p>
          <code className="mt-2 block text-xs break-all text-blue-400">
    ...
    <div className="flex min-h-screen items-center justify-center px-4 py-24">
      ...
      >
        <div className="mb-8 flex flex-col items-center text-center">
          ...
          >
            Or create a shareable claim link
          </Link>
        </div>
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-2">
            ...
            <textarea
              ...
              rows={3}
              className="w-full resize-none rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-white transition-all focus:border-blue-500/50 focus:outline-none"
